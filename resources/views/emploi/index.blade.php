<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-dark-800 leading-tight">
            {{ __("Affichage de l'emploi du temps du groupe") }}{{ $groupe->nomgrp }} du semestre
    ...
    <div class="container mt-5 mx-autoA">
        ...
        <div>
            <a href="{{ route('emploisPDF', [$seance->semestre,$seance->groupe]) }}" class="btn btn-primary bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded">Telecharger</a>
        </div>
</x-app-layout>
